...
public class ConfigurableLineRecordReader {
    private static final Log LOG = LogFactory.getLog(ConfigurableLineRecordReader.class.getName());
    ...
    public ConfigurableLineRecordReader(Configuration job, FileSplit split)
        throws IOException
    {
        this(job, split, null);
    }

    public ConfigurableLineRecordReader(Configuration job, FileSplit split, byte[] recordDelimiter)
        throws IOException
    {
        ...
        codecName = job.get("textfile.compress");
        if (codecName != null)
        {
        ...
        LOG.info("Using codec " + (codec != null ? codec.getClass().getName() : "NULL") + " for " + file.getName());
    ...
    public ConfigurableLineRecordReader(InputStream in, long offset, long endOffset,
                                        int maxLineLength) {
